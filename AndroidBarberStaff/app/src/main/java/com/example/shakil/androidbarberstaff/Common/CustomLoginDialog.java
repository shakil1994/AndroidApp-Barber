package com.example.shakil.androidbarberstaff.Common;
...
public class CustomLoginDialog {
    ...
    public void showLoginDialog(String title, String positiveText, String negativeText, Context context, final IDialogClickListener iDialogClickListener) {
        ...
        btn_login.setOnClickListener(v -> iDialogClickListener.onClickPositiveButton(dialog, edt_user.getText().toString(), edt_password.getText().toString()));

        btn_cancel.setOnClickListener(v -> iDialogClickListener.onClickNegativeButton(dialog));
    }
}
