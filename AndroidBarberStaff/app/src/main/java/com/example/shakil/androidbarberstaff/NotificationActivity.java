...
import com.example.shakil.androidbarberstaff.Adapter.MyNotificationAdapter;
import com.example.shakil.androidbarberstaff.Common.Common;
import com.example.shakil.androidbarberstaff.Interface.INotificationLoadListener;
    ...
    private void loadNotification(DocumentSnapshot lastDoc) {
        ...
        if (lastDoc == null) {
            notificationCollection.orderBy("serverTimestamp", Query.Direction.DESCENDING)
                    ...
                    .get()
                    .addOnFailureListener(e -> iNotificationLoadListener.onNotificationFailed(e.getMessage()))
